...
{
	/// <summary>
	/// The data source connection class. Implements both M-Files data source connection interfaces:
	/// IDataSourceConnection (MF7 and above)
	/// IDataSourceConnection2 (MF9 and above)
	/// </summary>
	public class VSDataSourceConnection : IDataSourceConnection2
	{
		...
		public VSDataSourceConnection( string ConnectionString )
		{
			m_item = null;
